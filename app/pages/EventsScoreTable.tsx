            ...
            <Table noWrapper>
                ...
                <TableBody>
                    ...
                    <TableRow key={index} className="group">
                        ...
                        <TableCell className="font-medium sticky left-0 bg-background group-hover:bg-muted transition-colors">{musician.totalScore}</TableCell>
                        <TableCell className="font-medium sticky left-0 bg-background group-hover:bg-muted transition-colors">{musician.percentageOfPresenceAtEvents} %</TableCell>
                    </TableRow>
                    ))}
                </TableBody>
            </Table>
